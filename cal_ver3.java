...
class tips{
    public void KeyInType_zh_cn() {
        System.out.println("选择一个重装类型（2b14/bgm71/at4/ags30/m2）");
    }

    public void KeyInType_en() {
        System.out.println("select the type of fire-support.(2b14/bgm71/at4/ags30/m2)");
    }

    public void KeyInAmount_zh_cn() {
        System.out.println("按顺序输入己方数值：(杀伤 破防 精度 装填）");
    }
    ...
    public void KeyInEnemy_zh_cn() {
        System.out.println("按顺序输入敌方数值：（闪避 力场 编制）");
    }
    ...
    public void SelLanguage() {
        System.out.println("选择你的语言/select your language(zh_cn中文/en英文)");
    }
}
